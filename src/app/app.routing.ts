    ...
    // Admin routes
    {
        ...
        children: [
            ...
            },
            {
                ...
                loadChildren: () => import('app/modules/admin/tenant-management/tenant-management.module').then(m => m.TenantManagementModule),
                data: {breadcrumb: {label: 'Tenant Management', url: 'tenant-management'}}
            },
        ]
    }
];
