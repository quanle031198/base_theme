...
export declare const TRANSLOCO_MISSING_HANDLER: InjectionToken<unknown>;
...
export declare class DefaultHandler implements TranslocoMissingHandler {
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<DefaultHandler, never>;
    static ɵprov: i0.ɵɵInjectableDeclaration<DefaultHandler>;
}
